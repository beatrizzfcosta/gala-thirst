                                    ...
                                    <div>
                                        ...
                                        <div className="mt-3 text-center sm:mt-5">
                                            ...
                                            <div className="mt-2" style={{height: "400px", overflow: "auto"}}>
                                                ...
                                                <Button
                                                    className="rounded-sm mb-7 bg-[#17CACE] px-10 py-2 text-sm font-semibold text-white shadow-md hover:bg-black hover:text-white ring-2 ring-[#17CACE] hover:ring-black"
                                                    onClick={acceptTerms}
                                                >
